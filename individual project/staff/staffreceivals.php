  ...
  <div class="sidebar">
    ...
    <div class="container">
                    ...
                    <div class="card_main">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Animals Purchased</h5>
                                <a href="addreceivals.php">
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            <tr>
                                                  ...
                                                  <td>
                                                    <a href="animaledit.php">
                                                    <button class="btn btn-primary">Edit</button>
                                                    </a>
                                              
                                                <a href="deletercvls.php?a=<?php echo $r['animal_id'];?>" onclick="return confirm('Are you sure you want to delete?');">
