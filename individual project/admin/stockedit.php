  ...
  <div class="sidebar">
    ...
    <div class="container">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  name="animal_type" id="animal_type"/>
         ...
         <?php
					...
					{
                        $id = $_POST['animal_id'];
						$aname = $_POST['animal_type'];
						$breed = $_POST['breed'];
						
                        
	
			
						$query= "UPDATE livestock SET animal_type ='$aname',breed='$breed', WHERE animal_id = '$id'";
